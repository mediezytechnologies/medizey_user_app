class GetDischageSummaryByIdModel {
  bool? status;
  String? response;
  HealthRecord? healthRecord;

  GetDischageSummaryByIdModel({this.status, this.response, this.healthRecord});

  GetDischageSummaryByIdModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
