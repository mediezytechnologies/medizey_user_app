...
import '../../../application/edit_member/edit_member_bloc.dart' as _i15;
import '../../../application/edit_member_image/edit_member_image_bloc.dart'
    as _i16;
import '../../../application/user_location/user_location_bloc.dart' as _i17;
...
import '../../../infrastructure/edit_member_image/edit_member_image_impl.dart'
    as _i9;
import '../../../infrastructure/user_location/user_location_impl.dart' as _i13;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i12.UserLocationRepo>(() => _i13.UserLoacationImpl());
  gh.factory<_i14.AddMemberImageBloc>(
      () => _i14.AddMemberImageBloc(get<_i3.AddMemberImageRepo>()));
  gh.factory<_i15.EditMemberBloc>(
      () => _i15.EditMemberBloc(get<_i10.EditMemberRepo>()));
  gh.factory<_i16.EditMemberImageBloc>(
      () => _i16.EditMemberImageBloc(get<_i8.EditMemberImageRepo>()));
  gh.factory<_i17.UserLocationBloc>(
      () => _i17.UserLocationBloc(get<_i12.UserLocationRepo>()));
  return get;
}
