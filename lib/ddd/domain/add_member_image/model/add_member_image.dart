...
AddMemberImags addMemberImagsFromJson(String str) => AddMemberImags.fromJson(json.decode(str));
...
class AddMemberImags {
    ...
    factory AddMemberImags.fromJson(Map<String, dynamic> json) => AddMemberImags(
        ...
        imageUplod: json["image_uplod"] == null ? null : ImageUplod.fromJson(json["image_uplod"]),
    );
