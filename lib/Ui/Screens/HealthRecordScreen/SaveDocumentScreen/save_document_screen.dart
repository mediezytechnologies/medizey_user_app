        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const VerticalSpacingWidget(height: 10),
              BlocConsumer<UploadDocumentFinalBloc, UploadDocumentFinalState>(
                listener: (context, state) {
                  if (state is UploadDocumentFinalLoaded) {
                    GeneralServices.instance.showSuccessMessage(
                        context, "Uploaded document successfully");
                  ...
                  if (state is UploadDocumentFinalError) {
                    GeneralServices.instance
                        .showSuccessMessage(context, "Uploaded document Error");
                  }
                },
                builder: (context, state) {
                  return CommonButtonWidget(
                      widget: state is UploadDocumentFinalLoading
