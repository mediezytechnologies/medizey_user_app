...
import 'package:mediezy_user/Ui/Screens/HealthRecordScreen/EditScanScreen/edit_scan_screen.dart';
import 'package:mediezy_user/Ui/Screens/HealthRecordScreen/ViewFileScreen/view_file_screen.dart';

class AllScanReportCardWidget extends StatelessWidget {
  const AllScanReportCardWidget(
      {super.key,
  ...
  final String scanCenterName;
  final String scanTestName;
