...
const Size _calendarPortraitDialogSizeM3 = Size(38.0, 512.0);
...
/// push [DatePickerDialogs] when the button is tapped.
///
...
Future<DateTime?> showDatePickerDemo({
  ...
  Widget dialog = DatePickerDialogs(
...
class DatePickerDialogs extends StatefulWidget {
  /// A Material-style date picker dialog.
DatePickerDialogs({
    super.key,
    DateTime? initialDate,
  ...
  /// {@template flutter.material.datePickerDialogs}
  ...
  /// Restoration ID to save and restore the state of the [DatePickerDialogs].
  ///
  ...
  /// Called when the [DatePickerDialogs] is toggled between
  ...
  @override
  State<DatePickerDialogs> createState() => _DatePickerDialogsState();
}

class _DatePickerDialogsState extends State<DatePickerDialogs> with RestorationMixin {
...
class DateRangePickerDialog extends StatefulWidget {
  ...
  /// {@macro flutter.material.datePickerDialogs}
  final TextInputType keyboardType;
