...
class GetFavDoctorWidget extends StatefulWidget {
  ...
  @override
  State<GetFavDoctorWidget> createState() =>
      _GetFavDoctorWidgetState();
}
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return DoctorCardWidget(
                              userAwayFrom: state.model
                                  [index].distanceFromUser
                                  .toString(),
                              clinicList: state.model[index].clinics!
                                  .toList(),
                              ...
                              imageUrl: state.model[index].docterImage
                                  .toString(),
                              mainHospitalName: state.model[index].mainHospital
                                  .toString(),
                              specialisation: state.model[index].specialization
                                  .toString(),
