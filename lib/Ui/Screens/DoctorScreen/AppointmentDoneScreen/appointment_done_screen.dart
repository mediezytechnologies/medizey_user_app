              ...
              return BlocListener<BookAppointmentBloc, BookAppointmentState>(
                listener: (context, state) {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => BookingConfirmationScreen(
                          ...
                          mobileNo: patientContactNumberController.text.isEmpty
                  ...
                  if (state is BookAppointmentError) {
                    Platform.isIOS
                        ? showErrorDialogueIos(context, state)
                        : showErrorDialogue(context, state);
                  }
                },
                child: BlocBuilder<GetFamilyMembersBloc, GetFamilyMembersState>(
                                  ...
                                  ? Row(
                                      ...
                                      children: [
                                        GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              patientIdSearchController.clear();
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        const VerticalSpacingWidget(height: 10),
                                        BlocBuilder<GetSymptomsBloc,
                                            GetSymptomsState>(
                                          builder: (context, state) {
                                            if (state is GetSymptomsLoaded) {
                                              getSymptomsModel = BlocProvider
                                                      .of<GetSymptomsBloc>(
                                                          context)
                                                  .getSymptomsModel;
                                              return Padding(
